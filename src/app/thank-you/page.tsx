        ...
        <main className='relative lg:min-h-full'>
            <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32'>
                <div className='lg:flex lg:items-center lg:space-x-8'>
                    <div className='relative h-[70vh] lg:w-1/2 lg:flex lg:justify-center lg:items-center'>
                        <Image
                    ...
                    <div className='lg:w-1/2'>
                        ...
                        <div className='mt-16 text-sm font-medium'>
                            ...
                            <ul className='mt-6 divide-y divide-foreground-800 border-t border-foreground-800 text-sm font-medium text-muted-foreground'>
                            ...
                            <div className='space-y-6 border-t border-foreground-800 pt-6 text-sm font-medium text-muted-foreground'>
                                <div className='flex justify-between'>
                                    <p>Subtotal</p>
                                    <p className='text-foreground'>{formatPrice(orderTotal)}</p>
                                </div>

                                <div className='flex justify-between'>
                                    <p>Transaction Fee</p>
                                    <p className='text-foreground'>{formatPrice(1)}</p>
                                </div>

                                <div className='flex items-center justify-between border-t border-foreground-800 pt-6 text-foreground'>
                            ...
                            <div className='mt-16 border-t border-foreground-800 py-6 text-right'>
                                <Link href='/products' className='text-sm font-medium text-purple-600 hover:text-purple-500'>
